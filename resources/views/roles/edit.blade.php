...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a class="active"></i> Edit Role</a></li>
        </ol>
    </section>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group {{ $errors->has('label') ? ' has-error' : '' }} col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="label" placeholder="Label" value="{{ old('label', $role->label) }}">
                            ...
                            <div class="row">
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }} col-md-4">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name" placeholder="Name" value="{{ old('name', $role->name) }}">
