...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a class="active"></i> Add Categories</a></li>
        </ol>
    </section>
                        ...
                        <div class="form-group {{ $errors->has('questions') ? ' has-error' : '' }} col-md-6">
                            ...
                            <select class="form-control select2" name="questions[]" multiple="multiple" data-placeholder="Select Questions" style="width: 100%;">
                                ...
                                @foreach ($questions as $question)
                                    <option value="{{ $question->id }}" {{ in_array($question->id, old('questions'.$i, $selected_questions)) ? 'selected' : '' }}>{{ $question->title }}</option>
                                    @php $i++; @endphp
                                @endforeach
                            </select>
