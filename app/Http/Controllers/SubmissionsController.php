...
class SubmissionsController extends Controller {
    ...
    public function pull(PullSubmissionRequest $request) {
        ...
        if ($request->type == Submission::REQ_TYPE_TODAY) {
        ...
        session()->flash('success', 'Pull request for submission initiated. Please wait for a minutes for submissions to be updated.');
        return back();
    }
}
